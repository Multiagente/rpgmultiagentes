...
public class Game {
	public static void main(String[] args) {
		...
		try {
			AgentController rma = cont.createNewAgent("rma", 
					"jade.tools.rma.rma", new Object[0]);
			rma.start();
			AgentController character1 = cont.createNewAgent("player1", 
					"br.unb.sma.dd.world.character.CharacterAgent" , null);
			character1.start();
			AgentController character2 = cont.createNewAgent("player2", 
					"br.unb.sma.dd.world.character.CharacterAgent" , null);
			character2.start();
			AgentController character3 = cont.createNewAgent("player3", 
					"br.unb.sma.dd.world.character.CharacterAgent" , null);
			character3.start();
			AgentController character4 = cont.createNewAgent("player4", 
					"br.unb.sma.dd.world.character.CharacterAgent" , null);
			character4.start();
